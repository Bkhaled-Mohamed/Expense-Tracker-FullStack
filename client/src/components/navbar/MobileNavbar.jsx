  ...
  return (
    <>
      <nav
        className={`${
          !showLocation ? "hidden" : ""
        } md:hidden h-12 w-full sticky flex items-center justify-between bg-slate-100 z-50`}
      >
        <div className="w-full flex flex-row justify-between px-4 items-center text-2xl">
        ...
        {show ? (
          <div className=" absolute top-0 left-0 h-screen">
            <nav className="  bg-slate-100  w-64 h-screen  z-30  relative">
              <div
                className=" flex justify-end h-24 p-5 text-4xl"
